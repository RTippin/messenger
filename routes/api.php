...
Route::prefix('v1')->name('api.')->group(function(){
    ...
    Route::prefix('messenger/join/{invite:code}')->group(function(){
        Route::get('/', [InviteController::class, 'show'])->middleware(['auth.optional:api', 'messenger.provider']);
        Route::post('/', JoinGroupInvite::class)->middleware(['auth:api', 'messenger.provider:required']);
    });
    //main authed routes
    Route::middleware([
        'auth:api',
