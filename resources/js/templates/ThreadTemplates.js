    ...
    templates = {
        ...
        thread_call_state : function(data){
            ...
            if(data.type === 1){
                return '<button onclick="ThreadManager.calls().initCall()" data-toggle="tooltip" title="Call '+Messenger.format().escapeHtml(data.name)+'" data-placement="left" ' +
                    'class="btn btn-lg text-secondary btn-light pt-1 pb-0 px-2 video_btn '+(!Messenger.common().mobile ? 'mr-1' : '')+'" type="button"><i class="fas fa-video fa-2x"></i></button>';
            }
        ...
        group_avatar : function(img){
            return '<div class="row">\n' +
                ...
                '                            <div class="col-4 col-md-3 grp-img-box"><label><img src="'+window.location.hostname+'/vendor/messenger/images/1.png" class="img-thumbnail grp-img-check grp-img-checked"><input type="radio" name="default_avatar" value="1.png" class="NS" autocomplete="off" checked></label></div>' +
                '                            <div class="col-4 col-md-3 grp-img-box"><label><img src="'+window.location.hostname+'/vendor/messenger/images/2.png" class="img-thumbnail grp-img-check"><input type="radio" name="default_avatar" value="2.png" class="NS" autocomplete="off"></label></div>' +
                '                            <div class="col-4 col-md-3 grp-img-box"><label><img src="'+window.location.hostname+'/vendor/messenger/images/3.png" class="img-thumbnail grp-img-check"><input type="radio" name="default_avatar" value="3.png" class="NS" autocomplete="off"></label></div>' +
                '                            </div>'+
                '                            <div class="row justify-content-center">' +
                '                            <div class="col-4 col-md-3 grp-img-box"><label><img src="'+window.location.hostname+'/vendor/messenger/images/4.png" class="img-thumbnail grp-img-check"><input type="radio" name="default_avatar" value="4.png" class="NS" autocomplete="off"></label></div>' +
                '                            <div class="col-4 col-md-3 grp-img-box"><label><img src="'+window.location.hostname+'/vendor/messenger/images/5.png" class="img-thumbnail grp-img-check"><input type="radio" name="default_avatar" value="5.png" class="NS" autocomplete="off"></label></div>' +
                '                            </div>'+
                '                        </div>\n' +
                '                    </div>\n' +
