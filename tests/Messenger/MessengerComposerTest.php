...
class MessengerComposerTest extends FeatureTestCase
{
    ...
    /** @test */
    public function it_stores_a_message_with_existing_thread()
    {
    ...
    /** @test */
    public function it_stores_a_message_and_creates_new_thread()
    {
    ...
    /** @test */
    public function it_sends_a_message_with_events()
    {
    ...
    /** @test */
    public function it_sends_a_message_without_broadcast()
    {
        BaseMessengerAction::enableEvents();
        $thread = $this->createPrivateThread($this->tippin, $this->doe);
