...
class Definitions
{
    ...
    const BotActionMatchMethods = [
        'contains' => 'The trigger can be anywhere within a message. Cannot be part or inside another word.',
        ...
        'starts:with' => 'The trigger must be the lead phrase within the message. Cannot be part or inside another word.',
