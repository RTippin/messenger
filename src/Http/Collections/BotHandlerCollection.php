...
use RTippin\Messenger\Http\Resources\BotHandlerResource;
use Throwable;

class BotHandlerCollection extends MessengerCollection
{
    /**
    ...
    {
        try {
            return (new BotHandlerResource($resource))->resolve();
        } catch (Exception $e) {
            report($e);
        } catch (Throwable $t) {
            report($t);
